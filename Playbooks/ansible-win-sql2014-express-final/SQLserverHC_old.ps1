...
$body += "<tr bgcolor=#DDDDDD><TH>ServerName</TH><TH>Instance Name</TH><TH>SQL Server</TH><TH>Uptime</TH><TH>Databases</TH><TH>Status</Th><TH>Size(MB)</TH><TH>DataSpaceUsage(KB)</Th><TH>SpaceAvailable(KB)</TH><TH>RecoveryModel</TH><TH>Full Backup</TH><TH>Differential Backup</TH><TH>Log Backup</TH></tr>"
...
################
	...
	$body += "<tr bgcolor=white align=left><TD><b>$srnm</b></TD><TD><b>$Instnm</b></TD><TD>$Agtst</TD><TD>$upt</TD><TD><b>$($Database.Name)</b></TD><TD>$DB1sts</TD></TD><TD>$($Database.Size)</TD><TD>$($Database.DataSpaceUsage)</TD><TD>$($Database.SpaceAvailable)</TD><TD>$($Database.RecoveryModel)</TD><TD>$LFBD</TD><TD>$LDBD</TD><TD>$LLBD</TD></TR>"
