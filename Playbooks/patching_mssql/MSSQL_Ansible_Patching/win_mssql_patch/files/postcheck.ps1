...
$msgBody += "<td bgcolor=#DDDDDD><FONT face=Verdana size=1.5 ><b>MSSQL Patching Post-check Report</b></font></td>"
$msgBody += "</tr>"
$msgBody += "<tr>"
...
#######file creation#######################
$File = "C:\pre_post\post_patch_report.html"
